...
_TerrainNormalmapTexture("InstancedPerPixelNormal", 2D) = "bump" {}
   ...
   SubShader {
      Tags{"RenderPipeline"="LightweightPipeline" "RenderType" = "Opaque" "Queue" = "Geometry+100" "IgnoreProjector" = "False" "SplatCount" = "16"}
...
void PrepareStochasticUVs(float scale, float2 uv, out float2 uv1, out float2 uv2, out float2 uv3, out half3 weights)
{
   ...
   Dependency "BaseMapShader" = "Hidden/MicroSplat/Terrain_Base-1962283193"
