...
void PrepareStochasticUVs(float scale, float2 uv, out float2 uv1, out float2 uv2, out float2 uv3, out half3 weights)
{
   ...
   weights = half3(w1, w2, w3);
            ...
            void DistanceResampleLOD(inout half oalbedo0, inout half oalbedo1, Config config, TriplanarConfig tc, half4 fxLevels, float3 worldPos, half4 weights)
            {
               ...
               half albedo0;
               half albedo1;
               half4 mipLevel = _TessData1.zzzz;
            ...
            float3 OffsetVertex(inout float4 vertex, float3 normal, inout float4 tangent, float2 texcoord)
            {
               ...
               fixed4 levelFx = 0;
                  ...
                  #if _MICROMESH
                  levelFx = SampleFXLevelsLOD(controlUV.xy);
                  #else
               ...
               half4 mipLevel = _TessData1.zzzz;
                  ...
                  DistanceResampleLOD(albedo0, albedo1, config, tc, levelFx, worldPos, weights);
               #endif
...
ENDCG
   ...
   Dependency "BaseMapGenShader" = "/Example_Tessellation_Base1548430666"
   Dependency "BaseMapShader" = "Hidden/MicroSplat/Example_Tessellation_Base1548430666"
