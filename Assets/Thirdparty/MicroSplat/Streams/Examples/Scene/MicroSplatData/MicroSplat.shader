      ...
      struct Input 
      {
         ...
         float3x3 TBN;
            ...
            fixed4 w0;
               ...
               fixed4 w6;
            #endif
            #if _MAX32TEXTURES && !_STREAMS && !_LAVA && !_WETNESS && !_PUDDLES
               fixed4 w7;
            #endif
...
ENDCG
   ...
   Dependency "BaseMapGenShader" = "/Example_Streams_Base-28983988"
   Dependency "BaseMapShader" = "Hidden/MicroSplat/Example_Streams_Base-28983988"
