...
Shader "MicroSplat/Example_Snow" {
   Properties {
      ...
      _SnowSSSTint("Subsurface Tint", Color) = (1,1,1,0.5)
               ...
               inout half3 SSSTint, inout half SSSThickness, float traxBuffer, float3 traxNormal)
         {
            ...
            MSBRANCHOTHER(snowFade)
            {
               ...
               #if _SNOWFOOTSTEPS
               {
                  ...
                  snowAlb.rgba = lerp(MICROSPLAT_SAMPLE_TEX2D_SAMPLER_GRAD(_SnowTrackDiff, _Diffuse, uv * _SnowTraxUVScales, fsdx, fsdy), snowAlb.rgba, traxBuffer);
                  snowNsao.rgba = lerp(MICROSPLAT_SAMPLE_TEX2D_SAMPLER_GRAD(_SnowTrackNSAO, _Diffuse, uv * _SnowTraxUVScales, fsdx, fsdy).garb + half4(traxNormal.xy, 0, 0), snowNsao.rgba, traxBuffer);
                  COUNTSAMPLE
                  COUNTSAMPLE
               }
               #endif
               ...
               half height = saturate(oheight - (1.0 - _SnowParams.x));
...
ENDCG
   ...
   Dependency "BaseMapGenShader" = "/Example_Snow_Base1406858517"
   Dependency "BaseMapShader" = "Hidden/MicroSplat/Example_Snow_Base1406858517"
