...
namespace JBooth.MicroSplat
{
   ...
   public class MicroSplatDetailResample : FeatureDescriptor
   {
      ...
      public override void DrawFeatureGUI (MicroSplatKeywords keywords)
      {
         ...
         noiseHeight = EditorGUILayout.Toggle (CNoiseHeight, noiseHeight);
...
#if __MICROSPLAT_TRIPLANAR__
         if (detailNoise || distanceNoise || noiseChannelCount != NormalNoiseChannels.Off || antiTileOptions != 0 || noiseHeight)
         {
      ...
      public override void Unpack(string[] keywords)
      {
         ...
         noiseHeight = HasFeature (keywords, DefineFeature._NOISEHEIGHT);
      ...
      {
         if (noiseHeight || detailNoise || distanceNoise || distanceResample != DistanceResampleMode.None || noiseChannelCount != NormalNoiseChannels.Off )
         {
      ...
      {
         if (noiseHeight || detailNoise || distanceNoise || distanceResample != DistanceResampleMode.None || noiseChannelCount != NormalNoiseChannels.Off || antiTileOptions != 0)
         {
