...
public class MicroSplatBlendableObjectEditor : Editor 
{
   ...
   public override void OnInspectorGUI()
   {
      ...
      bool normalBlendEnabled = (bmInstance != null && bo.msObject.keywordSO != null && bo.msObject.keywordSO.IsKeywordEnabled("_TBOBJECTNORMALBLEND")) ;
      ...
      if (bo.msObject.keywordSO != null && bo.msObject.keywordSO.IsKeywordEnabled("_TERRAINBLENDING"))
      {
         using (new GUILayout.VerticalScope(GUI.skin.box))
         {
            ...
            if (doTerrain.boolValue == true)
            {
               ...
               if (bo.msObject.keywordSO.IsKeywordEnabled("_TBNOISE") || bo.msObject.keywordSO.IsKeywordEnabled("_TBNOISEFBM"))
               {
      ...
      if (bo.msObject.keywordSO != null && bo.msObject.keywordSO.IsKeywordEnabled("_SNOW"))
      {
         using (new GUILayout.VerticalScope(GUI.skin.box))
         {
