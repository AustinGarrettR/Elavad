...
Shader "MicroSplat/Example_AlphaHole" {
   ...
   SubShader {
      ...
      float3 GetGlobalLightDir()
      {
         #if _MSRENDERLOOP_UNITYHD
            return normalize(_gGlitterLightWorldPos.xyz);
         #else
      ...
      {
         float3 lightDirWS = GetGlobalLightDir();
...
UNITY_INSTANCING_BUFFER_END(Terrain)
      ...
      MicroSplatLayer Sample(Input i, half4 weights, inout Config config, float camDist, float3 worldNormalVertex)
      {
         ...
         SAMPLE_PER_TEX(ptFuzz, 17.5, config, half4(0, 0, 1, 1));
               ...
               samples.normSAO0.a *= MicroShadow(lightDir, half3(samples.normSAO0.xy, 1), samples.normSAO0.a, ptFuzz0.a);
               samples.normSAO1.a *= MicroShadow(lightDir, half3(samples.normSAO1.xy, 1), samples.normSAO1.a, ptFuzz1.a);
               #if !_MAX2LAYER
                  samples.normSAO2.a *= MicroShadow(lightDir, half3(samples.normSAO2.xy, 1), samples.normSAO2.a, ptFuzz2.a);
               #endif
               #if !_MAX3LAYER || !_MAX2LAYER
                  samples.normSAO3.a *= MicroShadow(lightDir, half3(samples.normSAO3.xy, 1), samples.normSAO3.a, ptFuzz3.a);
               #endif
            #endif
...
ENDCG
   ...
   Dependency "BaseMapGenShader" = "/Example_AlphaHole_Base-859116955"
   Dependency "BaseMapShader" = "Hidden/MicroSplat/Example_AlphaHole_Base-859116955"
